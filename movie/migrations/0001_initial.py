    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(choices=[('POPULAR', 'POPULAR'), ('MOVIES', 'MOVIES'), ('CARTOON', 'CARTOON')], max_length=100)),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre', models.CharField(choices=[('ACTION', 'Action'), ('FANTASY', 'Fantasy'), ('HORROR', 'Horror'), ('ADVENTURE', 'Adventure'), ('COMEDY', 'Comedy')], max_length=100)),
